...
const Introduce = ({ setModeLogin }) => {
  const logo = <img src='img/abroad.png' height='16px' style={{ position: 'relative', top: 2 }} />
  return (
    <div style={styles.container}>
      <p>환영합니다 !</p><br />
      <p>이곳은 편리하게 환전을 할 수 있는 곳입니다. 은행에 갈 필요 없이 클릭 몇번으로 당신은 외화를 손에 쥘 수 있습니다.</p><br />
      <p style={styles.question}>집 앞에 있는 은행 냅두고 왜 여기서 환전을 하겠습니까?</p><br />
      <p>물론 당신이 직접 은행에 가서 환전하는 것이 귀찮지 않다면 그렇게 생각 하실 수도 있습니다. 하지만 오른쪽(또는 아래의) 환율정보를 보고 당신의 생각이 달라졌으면 좋겠습니다. {logo}는 그 어떤 은행보다 사용자에게 유리한 환율을 제공하고 있습니다. <span style={styles.mumble}>은행이 우리를 많이 미워하지 않았으면 좋겠ㅅ</span></p><br />
      <p style={styles.question}>그래서 어떻게 이용해야 된다는 겁니까?</p><br />
      ...
      <p>4. 환전하길 원하는 액수를 입력한 뒤 {logo}에서 환전할 경우 얼마를 절약할 수 있는지 확인합니다. (비교대상이 되는 환율은 {logo} 다음으로 사용자에게 가장 유리한 환율입니다.)</p>
